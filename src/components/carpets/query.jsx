    ...
    return (
      <div id={this.props.queryStyle} className="shadow-box z-depth-5" style={this.props.showForm?{display: 'block'}:{display: 'none'}}>
        ...
        <div style={{width: '100%', paddingTop: '10px', display: 'inline', height: '80px' }}>
          ...
          <h1 style={{fontSize: 'xx-large', width: '75%', height: '50px', textAlign: 'center', fontFamily: 'LabradorA', color: '#152F4A', margin: '0 auto', padding: '14px', float: 'left'}}>{this.props.headerTitle}</h1>
        ...
        <div className="queryDiv">
          <Requests callbackRequests={this.props.handleGetRequests} callbackSelectedRequests={this.props.handleChangeSelectedRequests} requestType={this.props.requestType}  />
