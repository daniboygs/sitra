    ...
    _createClass(TableRenderer, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          'table',
          { className: 'pvtTable', id: 'pvtTable' },
...
exports.default = {
  ...
  'Mapa de calor por columna': makeRenderer({ heatmapMode: 'col' }),
  'Mapa de calor por renglón': makeRenderer({ heatmapMode: 'row' }),
  'Exportar TSV': TSVExportRenderer*/
};
