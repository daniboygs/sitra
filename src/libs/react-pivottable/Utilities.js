...
var aggregators = function (tpl) {
  return {
    ...
    'Desviación estándar': tpl.stdev(1, usFmt),
    ...
    'Suma como fracción de renglones': tpl.fractionOf(tpl.sum(), 'row', usFmtPct),
    ...
    'Contar como fracción de renglones': tpl.fractionOf(tpl.count(), 'row', usFmtPct),
    'Contar como fracción de columnas': tpl.fractionOf(tpl.count(), 'col', usFmtPct)*/
  };
}(aggregatorTemplates);
