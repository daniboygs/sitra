  ...
  var Renderer = function (_React$PureComponent) {
    ...
    _createClass(Renderer, [{
      ...
      value: function render() {
        ...
        if (groupByTitle !== '') {
          if (titleText !== ''){
            titleText = groupByTitle + ' por ' +  titleText;
          }
          else{
...
function createPlotlyRenderers(PlotlyComponent) {
  return {
    'Seleccione alguna gráfica': makeRenderer(PlotlyComponent, { type: 'bar' }, { barmode: 'group' }),
    'Gráfica de columnas agrupadas': makeRenderer(PlotlyComponent, { type: 'bar' }, { barmode: 'group' }),
    'Gráfica de columnas apiladas': makeRenderer(PlotlyComponent, { type: 'bar' }, { barmode: 'relative' }),
    'Gráfica de barras agrupadas': makeRenderer(PlotlyComponent, { type: 'bar', orientation: 'h' }, { barmode: 'group' }, true),
    'Gráfica de barras apiladas': makeRenderer(PlotlyComponent, { type: 'bar', orientation: 'h' }, { barmode: 'relative' }, true),
    'Gráfica de lineas': makeRenderer(PlotlyComponent),
    'Gráfica de puntos': makeRenderer(PlotlyComponent, { mode: 'markers' }, {}, true),
    'Gráfica de área': makeRenderer(PlotlyComponent, { stackgroup: 1 }),
    'Gráfica de dispersión': makeScatterRenderer(PlotlyComponent),
    'Gráfica circular múltiple': makeRenderer(PlotlyComponent, { type: 'pie', scalegroup: 1, hoverinfo: 'label+value', textinfo: 'none' }, {}, true)
  };
}
